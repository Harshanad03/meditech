...
const Services = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      image: '/images/boyles-apparatus.jpg',
    ...
    },
    {
      id: 9,
      name: 'CPAP',
      description: 'Continuous Positive Airway Pressure therapy systems',
    ...
    },
    {
      ...
      image: '/images/o2-concentrator.jpg',
